...
/**
 * We need a separate interface for UserAttrs and UserDoc because
 *  UserAttrs are the set of attributes needed to create a User.
 * However, underneath the hood, MongoDB will add some custom properties to the created
 *  User Document.
 * UserDoc is for us to expose those properties so that TypeScript will be aware of them.
 */
